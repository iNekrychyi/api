...
* `403 Forbidden` – текущий пользователь не является работодателем.
* `404 Not Found` – у текущего пользователя нет прав на просмотр активных вакансий менеджера.
...
### Ошибки
* `403 Forbidden` – текущий пользователь не является работодателем.
* `404 Not Found` – у текущего пользователя нет прав на архивацию вакансии или вакансия с идентификатором vacancy_id не существует.
...
### Ошибки
* `403 Forbidden` – текущий пользователь не является работодателем.
* `404 Not Found` – у текущего пользователя нет прав на удаление вакансиии из архива или вакансия с идентификатором vacancy_id не существует.
...
### Ошибки
* `403 Forbidden` – текущий пользователь не является работодателем.
* `404 Not Found` – у текущего пользователя нет прав на удалении вакансии из архива или вакансия с идентификатором vacancy_id не существует.
...
### Ошибки
* `403 Forbidden` – текущий пользователь не является работодателем.
* `404 Not Found` – у текущего пользователя нет прав на редактирование вакансии из архива или вакансия с идентификатором vacancy_id не существует.
